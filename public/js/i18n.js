...
var translations = {
  en: {
    ...
    // --- Store ---
    'store_title': 'Store',
    'store_subtitle': 'Our Products',
    'store_no_products': 'No products available at this time.',
    'store_buy_now': 'Buy Now',
    'store_add_to_cart': 'Add to Cart',
    'store_select_option': 'Select option:',
    'store_unavailable': 'Currently unavailable',
    'store_your_cart': 'Your Cart',
    'store_cart': 'Shopping Cart',
    'store_cart_empty': 'Your cart is empty.',
    'store_continue_shopping': 'Continue Shopping',
    'store_total': 'Total:',
    'store_go_checkout': 'Proceed to Checkout',
    'store_checkout_subtitle': 'Complete Your Order',
    'store_checkout': 'Checkout',
    'store_order_summary': 'Order Summary',
    'store_shipping_info': 'Shipping Information',
    'store_full_name': 'Full Name *',
    'store_email': 'Email *',
    'store_phone': 'Phone',
    'store_address': 'Address *',
    'store_billing_info': 'Billing Information',
    'store_same_as_shipping': 'Same as shipping address',
    'store_billing_address': 'Billing Address *',
    'store_payment_method': 'Payment Method',
    'store_credit_card': 'Credit Card',
    'store_complete_purchase': 'Complete Purchase',
    'store_order_placed': 'Order Placed Successfully!',
    'store_order_confirmation': 'Thank you for your purchase. You will receive a confirmation email shortly.',
    'store_view_invoice': 'View Invoice',
    'store_order_id': 'Order ID:',
    'store_status': 'Status:',
    'store_order_history_sub': 'Track your purchases',
    'store_my_orders': 'My Orders',
    'store_login_to_view': 'Please log in to view your orders.',
    'store_no_orders': "You haven't placed any orders yet.",
    'store_login': 'Log In',
    'store_register': 'Register',
    'store_edit_profile': 'Edit Profile',
    'store_logout': 'Log Out',
    'store_password': 'Password',
    'store_no_account': "Don't have an account?",
    'store_have_account': 'Already have an account?',
    'store_current_password': 'Current Password',
    'store_new_password': 'New Password',
    'store_save': 'Save',
    'store_date': 'Date',

    // Admin store
    'store_products_page': 'Products',
    'store_orders_page': 'Orders',
    'store_add_product': 'Add Product',
    'store_product_image': 'Image',
    'store_product_title': 'Title',
    'store_product_price': 'Price',
    'store_product_available': 'Available',
    'store_product_options': 'Options',
    'store_product_description': 'Description',
    'store_product_images': 'Images (up to 5)',
    'store_customer': 'Customer',
    'store_all': 'All',
    'store_status_received': 'Received',
    'store_status_processing': 'Processing',
    'store_status_shipped': 'Shipped',
    'store_status_finished': 'Finished',
    'store_search_orders': 'Search by name, email, or ID...',
    'store_add_order': 'Add Order',
    'store_shipping_address': 'Shipping Address',
    'store_shipment_id': 'Shipment ID',
    'store_notes': 'Notes',
    ...
    'cnt_primary_color': 'Primary Color',
    'cnt_secondary_color': 'Secondary Color',
  ...
  pt: {
    ...
    // --- Store ---
    'store_title': 'Loja',
    'store_subtitle': 'Os Nossos Produtos',
    'store_no_products': 'Nenhum produto disponível de momento.',
    'store_buy_now': 'Comprar',
    'store_add_to_cart': 'Adicionar',
    'store_select_option': 'Selecionar opção:',
    'store_unavailable': 'Indisponível',
    'store_your_cart': 'O Seu Carrinho',
    'store_cart': 'Carrinho de Compras',
    'store_cart_empty': 'O seu carrinho está vazio.',
    'store_continue_shopping': 'Continuar a Comprar',
    'store_total': 'Total:',
    'store_go_checkout': 'Finalizar Compra',
    'store_checkout_subtitle': 'Complete a Sua Encomenda',
    'store_checkout': 'Pagamento',
    'store_order_summary': 'Resumo da Encomenda',
    'store_shipping_info': 'Informação de Envio',
    'store_full_name': 'Nome Completo *',
    'store_email': 'Email *',
    'store_phone': 'Telefone',
    'store_address': 'Morada *',
    'store_billing_info': 'Informação de Faturação',
    'store_same_as_shipping': 'Mesmo que morada de envio',
    'store_billing_address': 'Morada de Faturação *',
    'store_payment_method': 'Método de Pagamento',
    'store_credit_card': 'Cartão de Crédito',
    'store_complete_purchase': 'Confirmar Compra',
    'store_order_placed': 'Encomenda Realizada com Sucesso!',
    'store_order_confirmation': 'Obrigado pela sua compra. Receberá um email de confirmação em breve.',
    'store_view_invoice': 'Ver Fatura',
    'store_order_id': 'ID da Encomenda:',
    'store_status': 'Estado:',
    'store_order_history_sub': 'Acompanhe as suas compras',
    'store_my_orders': 'As Minhas Encomendas',
    'store_login_to_view': 'Inicie sessão para ver as suas encomendas.',
    'store_no_orders': 'Ainda não realizou nenhuma encomenda.',
    'store_login': 'Entrar',
    'store_register': 'Registar',
    'store_edit_profile': 'Editar Perfil',
    'store_logout': 'Sair',
    'store_password': 'Palavra-passe',
    'store_no_account': 'Não tem conta?',
    'store_have_account': 'Já tem conta?',
    'store_current_password': 'Palavra-passe Atual',
    'store_new_password': 'Nova Palavra-passe',
    'store_save': 'Guardar',
    'store_date': 'Data',

    // Admin store
    'store_products_page': 'Produtos',
    'store_orders_page': 'Encomendas',
    'store_add_product': 'Adicionar Produto',
    'store_product_image': 'Imagem',
    'store_product_title': 'Título',
    'store_product_price': 'Preço',
    'store_product_available': 'Disponível',
    'store_product_options': 'Opções',
    'store_product_description': 'Descrição',
    'store_product_images': 'Imagens (até 5)',
    'store_customer': 'Cliente',
    'store_all': 'Todos',
    'store_status_received': 'Recebido',
    'store_status_processing': 'Em Processamento',
    'store_status_shipped': 'Enviado',
    'store_status_finished': 'Concluído',
    'store_search_orders': 'Pesquisar por nome, email ou ID...',
    'store_add_order': 'Adicionar Encomenda',
    'store_shipping_address': 'Morada de Envio',
    'store_shipment_id': 'ID de Envio',
    'store_notes': 'Notas',
    'store_order_items': 'Itens',
    'admin': 'Admin',
    ...
    'cnt_primary_color': 'Cor Primária',
    'cnt_secondary_color': 'Cor Secundária',
